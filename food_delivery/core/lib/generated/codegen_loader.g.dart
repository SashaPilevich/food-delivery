...
class CodegenLoader extends AssetLoader{
  ...
  "adminPanelScreen": {
    ...
    "addSomeValue": "You have to add some value!",
    "haveToBeNumber": "The value have to be a number",
    "addImage": "Add image",
    "addProducts": "Add products",
    "cancel": "Cancel",
    "save": "Save",
    "changeOrderStatus": "Mark as completed",
    "activeUsers": "Active users",
    "totalSales": "Total sales",
    "noOrders": "There are no new orders",
    "orderCompleted": "Order is completed",
    "orderUncompleted": "Order is uncompleted",
    "newOrders": "New orders",
    "selectImage": "Select image",
    "uploadImage": "Upload image",
    "imageUpload": "Image is upload",
    "changeRole": "Change role",
    "productAdded": "New product is added!",
    "products": "Products",
    "removeProduct": "The product has been removed!",
    "areYouSure": "Are you sure you want to delete this product?",
    "delete": "Delete",
    "users": "Users",
    "orders": "Orders",
    "userRoleChanged": "User role is changed!"
  }
};
static const Map<String,dynamic> pl_PL = {
  ...
  "adminPanelScreen": {
    ...
    "addSomeValue": "Musisz dodać jakąś wartość!",
    "haveToBeNumber": "Wartość musi być liczbą!",
    "addImage": "Dodaj obraz",
    "addProducts": "Dodaj produkty",
    "cancel": "Anuluj",
    "save": "Zapisz",
    "changeOrderStatus": "Oznacz jako zakończone",
    "activeUsers": "Aktywni użytkownicy",
    "totalSales": "Całkowita sprzedaż",
    "noOrders": "Nie ma nowych zamówień",
    "orderCompleted": "Zamówienie zostało zakończone",
    "orderUncompleted": "Zamówienie nie zostało ukończone",
    "newOrders": "Nowe zamówienia",
    "selectImage": "Wybierz obraz",
    "uploadImage": "Prześlij obraz",
    "imageUpload": "Obraz jest załadowany",
    "changeRole": "Zmień rolę",
    "productAdded": "Dodano nowy produkt!",
    "products": "Produkty",
    "removeProduct": "Produkt został usunięty!",
    "areYouSure": "Czy na pewno chcesz usunąć ten produkt?",
    "delete": "Usunąć",
    "users": "Użytkownicy",
    "orders": "Zamówienia",
    "userRoleChanged": "Rola użytkownika została zmieniona!"
  }
};
